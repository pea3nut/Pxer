...
<div id="pxer">
	...
	<div id="pxer_main">
		<div id="pxer_main_logo">
			<img src="image/pxer_logo.png" alt="pxer" />
			<span>Pxer<em>β</em><strong>4.0</strong></span>
		</div>
		<ul id="pxer_main_nav">
	...
	<div id="pxer_about">
		<fieldset>
			...
			<p>制作者：<em><img src="image/PeA_nut.jpg" alt="PeA" />花生PeA</em></p>
			<p>软件官网：<em><a target="_blank" href="http://pxer.nutjs.com">http://pxer.nutjs.com</a></em></p>
			<p>软件中的任何部分禁止转载！©2015 Nutjs</p>
		</fieldset>
		<fieldset>
			<legend>特别感谢</legend>
			<p>图标提供者：<em><img src="image/BEBS DESIGN.jpg" alt="BD" />BEBS DESIGN</em></p>
